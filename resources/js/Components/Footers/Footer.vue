        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 lg:py-12">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
                    <div>
                        <h2
                            class="text-sm font-semibold uppercase tracking-wider text-gray-900 dark:text-white mb-4"
                        >
                            Legal
                        </h2>
                        <ul
                            class="space-y-3 text-base text-gray-500 dark:text-gray-400"
                        >
                            <li>
                                <a
                                    href="#"
            ...
            <!-- Bottom Section -->
            <div
                class="flex flex-col items-center space-y-4 sm:flex-row sm:justify-between sm:space-y-0"
            >
                <!-- Copyright -->
