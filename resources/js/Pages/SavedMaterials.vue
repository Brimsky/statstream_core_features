  ...
  <AuthenticatedLayout>
    <div class="container mx-auto px-4 py-10 dark:bg-neutral-800 bg-white">
      <div class="p-6 rounded-xl dark:bg-neutral-800 bg-white shadow-md ">
        <h4 class="text-xl font-semibold dark:text-white text-black  mb-4">Saved Materials</h4>
        <div class="mb-4">
          <label for="sort" class=" dark:text-white text-black">Sort by:</label>
        ...
        <div v-if="sortedMaterials.length">
          <div class="space-y-4">
            <div v-for="material in sortedMaterials" :key="material.id" class="p-4 bg-white dark:bg-neutral-800 shadow-md hover:shadow-lg rounded-md relative">
              <button @click="deleteMaterial(material.id)" class="absolute top-2 right-2 text-red-500">Delete</button>
              <div class="flex items-center space-x-4 mb-4">
                <div class="w-20 h-20 flex items-center justify-center rounded-md">
